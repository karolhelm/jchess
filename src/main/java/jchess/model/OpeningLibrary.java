...
public final class OpeningLibrary {

    private static final List<Opening> OPENINGS = List.of(
            new Opening("Sicilian Defense", new String[]{
            ...
            new Opening("Ruy Lopez", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
            ...
            new Opening("French Defense", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
            ...
            new Opening("Queen's Gambit", new String[]{
                    FenParser.STARTING_FEN,
            ...
            new Opening("Italian Game", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
                    "rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2",
                    "rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2",
            ...
            new Opening("Caro-Kann Defense", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
            ...
            new Opening("English Opening", new String[]{
                    FenParser.STARTING_FEN,
            ...
            new Opening("London System", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1",
                    "rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq d6 0 2",
            ...
            new Opening("King's Indian Defense", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1",
                    "rnbqkb1r/pppppppp/5n2/8/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 1 2",
                    "rnbqkb1r/pppppppp/5n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2",
                    "rnbqkb1r/pppp1p1p/5np1/8/2PP4/8/PP2PPPP/RNBQKBNR w KQkq - 0 3",
                    "rnbqkb1r/pppp1p1p/5np1/8/2PP4/2N5/PP2PPPP/R1BQKBNR b KQkq - 1 3",
                    "rnbqk2r/pppp1pbp/5np1/8/2PP4/2N5/PP2PPPP/R1BQKBNR w KQkq - 2 4"
            }),
            new Opening("Nimzo-Indian Defense", new String[]{
                    FenParser.STARTING_FEN,
                    "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1",
                    "rnbqkb1r/pppppppp/5n2/8/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 1 2",
                    "rnbqkb1r/pppppppp/5n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2",
